(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var transformQueryAndParameters = function (query, srcParameters) {
    ...
    var DataApiDriver = /** @class */ (function () {
        ...
        DataApiDriver.withRetry = function (run, ttl) {
            if (ttl === void 0) { ttl = 5; }
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_1 = _a.sent();
                            if (!(error_1.code === 'BadRequestException' &&
                                typeof error_1.retryDelay === 'number' &&
                                typeof error_1.message === 'string' &&
                                error_1.message.startsWith('Communications link failure'))) return [3 /*break*/, 4];
                            if (ttl === 0) {
                                console.log('DB cluster is paused. Retry limit reached.');
                                throw error_1;
                            }
                            console.log("DB cluster is paused. Retrying in " + error_1.retryDelay.toFixed(1) + "s\u2026");
                            return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, error_1.retryDelay * 1000); })];
                        case 3:
                            _a.sent();
                            return [2 /*return*/, DataApiDriver.withRetry(run, ttl - 1)];
        ...
        DataApiDriver.prototype.query = function (query, parameters) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            transformedQueryData = transformQueryAndParameters(query, parameters);
                            this.loggerFn(transformedQueryData.queryString, transformedQueryData.parameters);
                            return [4 /*yield*/, DataApiDriver.withRetry(function () {
        ...
        DataApiDriver.prototype.startTransaction = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, DataApiDriver.withRetry(function () { return _this.client.beginTransaction(); })];
                        case 1:
        ...
        DataApiDriver.prototype.commitTransaction = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, DataApiDriver.withRetry(function () { return _this.client.commitTransaction({ transactionId: _this.transactionId }); })];
                        case 1:
                            _a.sent();
        ...
        DataApiDriver.prototype.rollbackTransaction = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, DataApiDriver.withRetry(function () { return _this.client.rollbackTransaction({ transactionId: _this.transactionId }); })];
                        case 1:
                            _a.sent();
                            this.transactionId = undefined;
                            return [2 /*return*/];
